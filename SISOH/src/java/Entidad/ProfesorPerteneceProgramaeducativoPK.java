...
public class ProfesorPerteneceProgramaeducativoPK implements Serializable {
    ...
    public String toString() {
        return "Entidad.ProfesorPerteneceProgramaeducativoPK[ profesorPROid=" + profesorPROid + ", programaEducativoPEDid=" + programaEducativoPEDid + ", cicloEscolarCESid=" + cicloEscolarCESid + " ]";
    }

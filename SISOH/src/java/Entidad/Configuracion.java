...
public class Configuracion implements Serializable {
    ...
    @ManyToMany(mappedBy = "configuracionCollection")
    private Collection<Calendarioreporte> calendarioreporteCollection;
    ...
    @XmlTransient
    public Collection<Calendarioreporte> getCalendarioreporteCollection() {
        return calendarioreporteCollection;
    }

    public void setCalendarioreporteCollection(Collection<Calendarioreporte> calendarioreporteCollection) {
        this.calendarioreporteCollection = calendarioreporteCollection;
    }
    ...
    public String toString() {
        return "Entidad.Configuracion[ cONid=" + cONid + " ]";
    }

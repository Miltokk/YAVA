...
////cambios para renderizar el menu automaticamente al tener un solo rol
    ...
    /**
     * Metodo que crea el menu dentro de MenuTemplate.xhtml
     *
     * @param list
     * @param seleccionado
     * @return
    ...
    public boolean RenderizarMenu(List<Rol> list, String seleccionado) {
        ...
        DefaultMenuItem MenuRACT = new DefaultMenuItem("Consulta avance contenido tematico");
        
        DefaultSubMenu MenuAvanceContenidoTematico = new DefaultSubMenu("Avance contenido tematico");
        DefaultMenuItem OpcAvanceContenido = new DefaultMenuItem("Avance contenido");
        DefaultMenuItem OpcConsultaRACTS= new DefaultMenuItem("Consulta contenido tematico");
        
        //DefaultMenuItem MenuAvanceContenidoTematico = new DefaultMenuItem("Avance contenido temÃ¡tico");
	...
	MenuRACT.setIcon("btnAvance");
  	MenuAvanceContenidoTematico.addElement(OpcAvanceContenido);
        MenuAvanceContenidoTematico.addElement(OpcConsultaRACTS);
...
//        DefaultSubMenu MenuConfiguracion = new DefaultSubMenu("Configuración del sistema");
        ...
        DefaultSubMenu MenuCatalogos = new DefaultSubMenu("Catalogos");
...
//        DefaultSubMenu MenuReportes = new DefaultSubMenu("Reportes");
        ...
        DefaultMenuItem MenuEdificios = new DefaultMenuItem("Edificios");
        MenuEdificios.setOutcome("edificios");
        MenuEdificios.setRendered(false);
        DefaultMenuItem MenuSalones = new DefaultMenuItem("Salones");
        MenuSalones.setOutcome("salones");
        MenuSalones.setRendered(false);
        ...
        DefaultMenuItem OpcEdificios = new DefaultMenuItem("Edificios");
        DefaultMenuItem OpcSalones = new DefaultMenuItem("Salones");
        ...
        OpcEdificios.setOutcome("edificios");
        OpcSalones.setOutcome("Salones");
        ...
        OpcEdificios.setRendered(false); //SISOH
        OpcSalones.setRendered(false);
...
//        MenuCatalogos.addElement(OpcAdmonProfesores);
       // MenuCatalogos.addElement(OpcEdificios); //SISOH
        ...
        //MenuCatalogos.addElement(MenuEdificios);
        ...
        model.addElement(MenuEdificios);
        model.addElement(MenuSalones);
       ...
       DefaultMenuItem OpcAreaConAdm = new DefaultMenuItem("Área administrativa");
        //DefaultMenuItem OpcAreaConAdm = new DefaultMenuItem("Prueba");
	 ...
	 if(seleccionado.equals("Profesor")){
            ...
            if (rol.getRoltipo().equals(seleccionado)) {
                ...
                for (Permiso per : list2) {
                    ...
                    if (per.getPertipo().equals("Administración de contenido temático")) { //SISOH

                        MenuEdificios.setRendered(true);
                        OpcEdificios.setRendered(true);

                    }
//                    if (per.getPertipo().equals("Administración de contenido temático")) { //SISOH
//
//                        MenuSalones.setRendered(true);
//                        OpcSalones.setRendered(true);
//
//                    }
